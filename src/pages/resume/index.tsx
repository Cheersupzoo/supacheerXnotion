    ...
    <Layout>
      ...
      <div className='printable' data-size='A4'>
        ...
        <div className='grid grid-cols-[10fr_18fr] pt-6'>
          ...
          <div className='pr-11'>
            <div className='text-purple text-[14pt] font-bold'>EXPERIENCE</div>
            ...
            <div className='-mt-1 text-end text-[11pt]'>Aug 2023 - Present</div>
            <div className='pl-5 text-justify text-[9pt] leading-[17pt]'>
              ...
              <br />
               Engineered a robust web application for business flight search,
              focusing on optimizing performance for displaying and processing
              ...
              JSDoc documentation for a js codebase, refining code documentation
              for greater clarity, and implementing end-to-end (E2E) testing for
              unique, custom use cases.
              <br />
            ...
            <div className='pl-5 text-justify text-[9pt] leading-[17pt]'>
              ...
              template system used in generating PDFs for various purposes like
              invoices and sales reports.
              <br />
               Enhanced microstore input validation for real-time user
              feedback, significantly improving UX and meeting complex business
              needs.
              <br />
               Managed CI/CD pipelines utilizing GitHub Actions and internal
              tools.
              <br />
               Maintained key internal libraries, including Apollo GraphQL and
              GraphQL Subscriptions.
              <br />
              <span className='font-bold'>Tech Stack</span> Node.js + Typescript
              + GraphQL + PostgreSQL + Prisma + Serverless + Next.JS
            </div>
            ...
            <div className='pl-5 text-justify text-[9pt] leading-[17pt]'>
              Developed a dynamic NHSO system auditing website using Spring Boot
              and Thymeleaf, and maintained the Samitivej Plus hospital app,
              enhancing security and adding a promotional course package selling
              feature.
            </div>
            ...
            <div className='mt-1 pl-5 text-justify text-[9pt] leading-[15pt]'>
              ...
              <br />
              Bachelor Degree in Computer engineering. Current GPA: 3.80 / 4.00
            </div>
          </div>
        </div>
      </div>
